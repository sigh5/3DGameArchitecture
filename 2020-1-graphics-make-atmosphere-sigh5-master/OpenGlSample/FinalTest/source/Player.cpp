...
void Player::setRot(float speed, float x, float y, float z)
{
	rotSpeed = speed;
...
void Player::setCameraPos(float x, float y, float z)
{
...
void Player::init()
{
	...
	filemgr->loadObj(this, "human_2.obj", "human2.bmp", "20161677_황현욱_vs.shader", "20161677_황현욱_fs.shader");
...
void Player::addComposite(CompositeObj* addObj)
{
...
void Player::setLive(bool _IsLive)
{
	IsLive = _IsLive;
}