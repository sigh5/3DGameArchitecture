#include "../FinalTest/include/BackGround.h"
#include "FileManager.h"


void BackGround::setPos(float x, float y, float z)
{
...
void BackGround::init()
{
	...
	filemgr->loadObj(this, "cube.obj", "BG.bmp", "20161677_황현욱_vs.shader", "20161677_황현욱_fs.shader");
	this->setPos(0, 0, -30);
...
void BackGround::addComposite(CompositeObj* addObj)
{
